  ...
  return (function (t) {
    ...
    function (t, e, n) {
      (function (t, r, i, o) {
        ...
        function k(e, n) {
          t.isBuffer(e)
            ? n()
            : n(new Fe(be.EINVAL, "option must be a Buffer."));
        }
        function I(t, e, n) {
          function r(t) {
            ...
            u = function (t) {
              if (i.hasOwnProperty(t)) {
                ...
                if (void 0 === u || null === u) {
                  ...
                  var h = !1;
                  if (
                    ((h = Array.isArray(c.type)
                      ? c.type.indexOf(typeof u) !== -1
                      : typeof u === c.type),
                    !h)
                  )
                    return a
        ...
        function mt() {
          Zr ||
            ((Zr = {}),
            (Zr[Dropbox.ApiError.NETWORK_ERROR] = be.EIO),
            (Zr[Dropbox.ApiError.INVALID_PARAM] = be.EINVAL),
            (Zr[Dropbox.ApiError.INVALID_TOKEN] = be.EPERM),
            (Zr[Dropbox.ApiError.OAUTH_ERROR] = be.EPERM),
            (Zr[Dropbox.ApiError.NOT_FOUND] = be.ENOENT),
            (Zr[Dropbox.ApiError.INVALID_METHOD] = be.EINVAL),
            (Zr[Dropbox.ApiError.NOT_ACCEPTABLE] = be.EINVAL),
            (Zr[Dropbox.ApiError.CONFLICT] = be.EINVAL),
            (Zr[Dropbox.ApiError.RATE_LIMITED] = be.EBUSY),
            (Zr[Dropbox.ApiError.SERVER_ERROR] = be.EBUSY),
            (Zr[Dropbox.ApiError.OVER_QUOTA] = be.ENOSPC));
        }
        function _t(t) {
        ...
        function Et(t) {
          return (
            null === t ||
            void 0 === t ||
            ("object" == typeof t && "number" == typeof t.byteLength)
          );
        }
        function bt(t, e) {
          void 0 === e && (e = "");
        ...
        function kt(t, e) {
          return "function" == typeof e
            ? function (n) {
                arguments.length > 0 && (arguments[0] = St(t, n)),
        ...
        function It(t, e, n) {
          return "Sync" !== t.slice(t.length - 4)
            ? function () {
                return (
                  arguments.length > 0 &&
                    (e && (arguments[0] = ke.join(this._folder, arguments[0])),
                    n && (arguments[1] = ke.join(this._folder, arguments[1])),
                    (arguments[arguments.length - 1] = kt(
                      this._folder,
        ...
        function jt(t) {
          return { type: Wi.API_ERROR, errorData: Yt(t.writeToBuffer()) };
        }
        function Bt(t) {
        ...
        function Vt(t) {
          return { type: Wi.STATS, statsData: Yt(t.toBuffer()) };
        }
        function Wt(t) {
          return Te.fromBuffer(Xt(t.statsData));
        }
        function Ht(t) {
          return { type: Wi.FILEFLAG, flagStr: t.getFlagString() };
        }
        function Zt(t) {
        ...
        function Kt(t) {
          return { type: Wi.BUFFER, data: Yt(t) };
        }
        function Jt(t) {
          return Xt(t.data);
        }
        ...
        function te(e, n) {
          ...
          if (
            ...
            (r.onreadystatechange = function (e) {
              if (4 === r.readyState) {
                if (200 !== r.status)
                  return void (o = new Fe(r.status, "XHR error."));
                switch (n) {
                  case "buffer":
        ...
        function ne(t, e, n) {
          ...
          r.open("HEAD", e, t),
            (r.onreadystatechange = function (t) {
              if (4 === r.readyState) {
                if (200 !== r.status)
                  return n(new Fe(r.status, "XHR HEAD error."));
                try {
                  return n(
                    null,
        ...
        function ge(e) {
          ...
          e.require = function (t) {
            ...
            return e
              ? e
              : n.apply(null, Array.prototype.slice.call(arguments, 0));
          };
        }
        function ve(t, e) {
          Zo[t] = e;
        ...
        var Ie = {};
        (Ie[be.EPERM] = "Operation not permitted."),
          (Ie[be.ENOENT] = "No such file or directory."),
          (Ie[be.EIO] = "Input/output error."),
          (Ie[be.EBADF] = "Bad file descriptor."),
          (Ie[be.EACCES] = "Permission denied."),
          (Ie[be.EBUSY] = "Resource busy or locked."),
          (Ie[be.EEXIST] = "File exists."),
          (Ie[be.ENOTDIR] = "File is not a directory."),
          (Ie[be.EISDIR] = "File is a directory."),
          (Ie[be.EINVAL] = "Invalid argument."),
          (Ie[be.EFBIG] = "File is too big."),
          (Ie[be.ENOSPC] = "No space left on disk."),
          (Ie[be.EROFS] = "Cannot modify a read-only file system."),
          (Ie[be.ENOTEMPTY] = "Directory is not empty."),
          (Ie[be.ENOTSUP] = "Operation is not supported.");
        var Oe,
          Fe = (function (e) {
            function n(t, n, r) {
              void 0 === n && (n = Ie[t]),
        ...
        var Re = function t(e) {
          if (((this.flagStr = e), t.validFlagStrs.indexOf(e) < 0))
            throw new Fe(be.EINVAL, "Invalid flag: " + e);
        };
        (Re.getFileFlag = function (t) {
          return Re.flagCache.hasOwnProperty(t)
            ? Re.flagCache[t]
            : (Re.flagCache[t] = new Re(t));
        }),
        ...
        (Ae.prototype.initialize = function (t) {
          ...
          (Ae.prototype.openSync = function (t, e, n) {
            return (
              void 0 === n && (n = 420),
              this.getFdForFile(
                s(this.root).openSync(u(t), Re.getFileFlag(e), a(n, 420)),
              )
            );
          }),
                ...
                default:
                  return (s =
                    "function" == typeof i
                      ...
                      : "function" == typeof o
                        ? o
                        : s)(new Fe(be.EINVAL, "Invalid arguments."));
              }
          ...
          (Ae.prototype.symlink = function (t, e, n, r) {
            ...
            try {
              if ("file" !== i && "dir" !== i)
                return o(new Fe(be.EINVAL, "Invalid type: " + i));
          ...
          (Ae.prototype.symlinkSync = function (t, e, n) {
            if (n) {
              if ("file" !== n && "dir" !== n)
                throw new Fe(be.EINVAL, "Invalid type: " + n);
            } else n = "file";
        ...
        var Ve = function (t, e, n, r) {
          void 0 === t && (t = self.FS),
            ...
            (this.PATH = e),
            (this.ERRNO_CODES = n),
            (this.node_ops = new qe(this)),
            (this.stream_ops = new ze(this));
        };
              ...
              (e.prototype.openSync = function (t, e, n) {
                ...
                return (
                  ...
                  new Ke(
                    ...
                    this._sync.readFileSync(t, null, Re.getFileFlag("r")),
                  )
                );
              }),
        ...
        var kr,
          ...
          Br = "[" + Lr + "]?",
          zr =
            ("(?:" + Mr + "(?:" + [Pr, Cr, Ur].join("|") + ")" + Br + jr + ")*",
            "(?:" + [Pr + xr + "?", xr, Cr, Ur, Tr].join("|") + ")",
        ...
        (Yr.prototype.readdir = function (t, e) {
          ...
          this._wrap(
            function (e) {
              null !== r && r.contents
                ? n._client.readdir(t, { contentHash: r.stat.contentHash }, e)
                : n._client.readdir(t, e);
            },
            function (i, o, s, a) {
              i
          ...
          (Yr.prototype.readFile = function (t, e) {
            ...
            null !== r && null !== r.contents
              ? this.stat(t, function (i, o) {
                  i
                    ? e(i)
                    : o.contentHash === r.stat.contentHash
                      ? e(i, r.contents.slice(0), r.stat)
                      : n.readFile(t, e);
                })
              : this._wrap(
                  function (e) {
          ...
          (Yr.prototype.updateCachedDirInfo = function (t, e, n) {
            ...
            null === e.contentHash ||
              (void 0 !== r && r.stat.contentHash === e.contentHash) ||
              this.putCachedInfo(t, { stat: e, contents: n });
          }),
          (Yr.prototype.updateCachedFileInfo = function (t, e, n) {
            void 0 === n && (n = null);
            var r = this.getCachedInfo(t);
            null === e.versionTag ||
              (void 0 !== r && r.stat.versionTag === e.versionTag) ||
              this.putCachedInfo(t, { stat: e, contents: n });
          }),
          (Yr.prototype.updateCachedInfo = function (t, e, n) {
            void 0 === n && (n = null),
              e.isFile && Et(n)
                ? this.updateCachedFileInfo(t, e, n)
                : e.isFolder &&
                  Array.isArray(n) &&
                  this.updateCachedDirInfo(t, e, n);
          });
        var Xr = (function (t) {
            function e(e, n, r, i, o) {
              t.call(this, e, n, r, i, o);
              ...
              (e.prototype._remove = function (t, e, n) {
                ...
                this._client.stat(t, function (i, o) {
                  i
                    ? e(r.convert(i, t))
                    : o.isFile && !n
                      ? e(Fe.FileError(be.ENOTDIR, t))
                      : !o.isFile && n
                        ? e(Fe.FileError(be.EISDIR, t))
          ...
          (Kr.Options = {
            client: {
              ...
              validator: function (t, e) {
                t.isAuthenticated && t.isAuthenticated()
                  ? e()
                  : e(
                      new Fe(
                        be.EINVAL,
            ...
            return (
              ...
              (n.prototype.renameSync = function (t, e) {
                try {
                  ...
                  throw n.errno === be.ENOENT
                    ? bt(n, this.existsSync(t) ? e : t)
                    : bt(n);
                }
              }),
              ...
              (n.prototype.openSync = function (t, e, n) {
                try {
                  ...
                  if (this._FS.isDir(r.node.mode))
                    throw (this._FS.close(r), Fe.EISDIR(t));
        ...
        var ti = $r,
          ...
          ri = (function (t) {
            function e(n, r, i) {
              void 0 === n && (n = 5),
                void 0 === r && (r = ti.PERSISTENT),
                void 0 === i && (i = !0),
                t.call(this),
                (this.size = 1048576 * n),
                (this.type = r),
                d(i, e.Name, { size: n, type: r });
            }
            return (
              t && (e.__proto__ = t),
              (e.prototype = Object.create(t && t.prototype)),
        ...
        (ii.fromBuffer = function (t) {
          ...
          (ii.prototype.toStats = function () {
            return new Te(
              (61440 & this.mode) === Le.DIRECTORY ? Le.DIRECTORY : Le.FILE,
              this.size,
              this.mode,
              new Date(this.atime),
              new Date(this.mtime),
            ...
            return (
              ...
              (n.prototype._findINode = function (t, e, n) {
                ...
                return "/" === e
                  ? "" === n
                    ? oi
                    : i(this.getINode(t, e, oi))
                  : i(
                      this.getINode(
                        t,
                        e + ke.sep + n,
                        this._findINode(t, ke.dirname(e), ke.basename(e)),
                      ),
                    );
              }),
          ...
          hi = (function (e) {
            ...
            return (
                  ...
                  xt(o, n) &&
                    i.get(s.id, function (i, o) {
                      xt(i, n) &&
                        (void 0 === o
                          ? n(Fe.ENOENT(t))
                          : n(null, new fi(r, t, e, s.toStats(), o)));
                    });
                });
              }),
                ...
                e.get(oi, function (n, r) {
                  if (n || void 0 === r) {
                    ...
                    e.put(o.id, Lt(), !1, function (n) {
                      At(n, e, t) &&
                        e.put(oi, o.toBuffer(), !1, function (n) {
                          n
                            ? e.abort(function () {
                                t(n);
                              })
                ...
                var i = this,
                  o = function (t, i, o) {
                    t
                      ...
                      : o[n]
                        ? r(null, o[n])
                        : r(Fe.ENOENT(ke.resolve(e, n)));
                  };
                "/" === e
                  ? "" === n
                    ? r(null, oi)
                    : this.getINode(t, e, oi, function (n, s) {
                        xt(n, r) &&
              ...
              (n.prototype.commitNewFile = function (e, n, r, i, o, s) {
                ...
                return "/" === n
                  ? s(Fe.EEXIST(n))
                  : void this.findINodeAndDirListing(e, c, function (c, h, p) {
                      At(c, e, s) &&
                        (p[u]
                          ? e.abort(function () {
                              s(Fe.EEXIST(n));
        ...
        var gi = (function (t) {
          ...
          vi = function (t, e) {
            ...
            (r.onupgradeneeded = function (t) {
              ...
              e.objectStoreNames.contains(n.storeName) &&
                e.deleteObjectStore(n.storeName),
                e.createObjectStore(n.storeName);
            }),
        ...
        var mi = (function (t) {
          function e(n, r, i) {
            ...
            void 0 === i && (i = !0),
              t.call(this),
              (this.store = new vi(function (t) {
                t
                  ? n(t)
                  : o.init(o.store, function (t) {
                      n(t, o);
                    });
              }, r)),
              d(i, e.Name, { storeName: r });
          }
          return (
            t && (e.__proto__ = t),
            (e.prototype = Object.create(t && t.prototype)),
            ...
            (e.isAvailable = function () {
              try {
                return (
                  "undefined" != typeof di &&
                  null !== di.open("__browserfs_test__")
                );
              } catch (t) {
                return !1;
              }
        ...
        var _i,
          wi = !1;
        try {
          ti.localStorage.setItem("__test__", String.fromCharCode(55296)),
            (wi =
              ti.localStorage.getItem("__test__") ===
              String.fromCharCode(55296));
        } catch (t) {
          wi = !1;
        }
        (_i = wi ? "binary_string" : "binary_string_ie"),
          t.isEncoding(_i) || (_i = "base64");
        var Ei = function () {};
        (Ei.prototype.name = function () {
          ...
          (Ei.prototype.put = function (t, e, n) {
            try {
              return (
                !(!n && null !== ti.localStorage.getItem(t)) &&
                (ti.localStorage.setItem(t, e.toString(_i)), !0)
              );
            } catch (t) {
            ...
            (e.prototype.rename = function (t, e, n) {
              ...
              return i.fs === o.fs
                ...
                : Pe.readFile(t, function (r, i) {
                    return r
                      ? n(r)
                      : void Pe.writeFile(e, i, function (e) {
        ...
        for (
          ...
          for (var Oi = ki[Ii], Fi = 0, Ni = Oi; Fi < Ni.length; Fi += 1) {
            var Ri = Ni[Fi];
            (Si.prototype[Ri] = Ct(Ri, !1, Ii + 1)),
              (Si.prototype[Ri + "Sync"] = Ct(Ri + "Sync", !0, Ii + 1));
          }
        var Li;
        if ("undefined" != typeof setImmediate) Li = setImmediate;
          ...
          var Ti = ti,
            ...
            Di = function () {
              if ("undefined" != typeof Ti.importScripts || !Ti.postMessage)
                return !1;
              var t = !0,
                e = Ti.onmessage;
              return (
                (Ti.onmessage = function () {
                  t = !1;
                }),
                Ti.postMessage("", "*"),
                (Ti.onmessage = e),
          ...
          if (Di()) {
            ...
            Ti.addEventListener
              ? Ti.addEventListener("message", Pi, !0)
              : Ti.attachEvent("onmessage", Pi);
        ...
        (Mi.prototype.lock = function (t) {
          return this._locked
            ? void this._waiters.push(t)
            : ((this._locked = !0), void t());
        }),
            ...
            return (
              ...
              (e.prototype.rename = function (t, e, n) {
                ...
                if (
                  ...
                  return t === Bi || e === Bi
                    ? n(Fe.EPERM("Cannot rename deletion log."))
                    : t === e
                      ? n()
                      : void this.stat(t, !1, function (i, o) {
                          return i
                            ...
                            : r.stat(e, !1, function (i, s) {
                                ...
                                if (o.isDirectory()) {
                                  if (i)
                                    return i.errno !== be.ENOENT
                                      ? n(i)
                                      : r._writable.exists(t, function (i) {
                                          return i
                                            ? r._writable.rename(t, e, n)
                                            : void r._writable.mkdir(
                                                e,
                                                u,
                                                function (e) {
                                                  return e
                                                    ? n(e)
                                                    : void r._readable.readdir(
                                                        t,
                                                        function (t, e) {
                                                          return t
                                                            ? n()
              ...
              (e.prototype.renameSync = function (t, e) {
                ...
                if (
                  ...
                  throw Fe.EPERM("Cannot rename deletion log.");
              ...
              (e.prototype.stat = function (t, e, n) {
                ...
                this.checkInitAsync(n) &&
                  this._writable.stat(t, e, function (i, o) {
                    i && i.errno === be.ENOENT
                      ? (r._deletedFiles[t] && n(Fe.ENOENT(t)),
                        r._readable.stat(t, e, function (t, e) {
                          e && ((e = e.clone()), (e.mode = Ut(e.mode))),
                            n(t, e);
                        }))
                      : n(i, o);
                  });
              ...
              (e.prototype.openSync = function (t, e, n) {
                if ((this.checkInitialized(), this.checkPath(t), t === Bi))
                  throw Fe.EPERM("Cannot open deletion log.");
              ...
              (e.prototype.copyToWritable = function (t) {
                ...
                e.isDirectory()
                  ...
                  : this.writeFileSync(
                      t,
                      this._readable.readFileSync(t, null, Mt("r")),
                      null,
                      Mt("w"),
        ...
        (Hi.prototype.toRemoteArg = function (t) {
          var e = this._nextId++;
          return (this._callbacks[e] = t), { type: Wi.CB, id: e };
        }),
        ...
        var Yi = (function (t) {
          ...
          Xi = (function (e) {
            function n(t, r) {
              ...
              void 0 === r && (r = !0),
                e.call(this),
                (this._callbackConverter = new Hi()),
                (this._isInitialized = !1),
                (this._isReadOnly = !1),
                (this._supportLinks = !1),
                (this._supportProps = !1),
                (this._worker = t),
                d(r, n.Name, { worker: "Web Worker instance" }),
                    ...
                    switch (e.type) {
                      ...
                      case Wi.FD:
                        ...
                        return new Yi(
                          this,
                          n.path,
                          Re.getFileFlag(n.flag),
                          Te.fromBuffer(Xt(n.stat)),
                          n.id,
                          Xt(n.data),
                        );
                      case Wi.STATS:
        ...
        (Gi.fromListing = function (t) {
            ...
            for (var u in a)
              if (a.hasOwnProperty(u)) {
                var f = a[u],
                  h = s + "/" + u;
                f
                  ? ((e._index[h] = i = new $i()), r.push([h, f, i]))
                  : (i = new Qi(new Te(Le.FILE, -1, 365))),
                  c && (c._ls[u] = i);
              }
          }
          return e;
          ...
          (Gi.prototype.addPath = function (t, e) {
            ...
            return (
              !(
                void 0 === o &&
                "/" !== t &&
                ((o = new $i()), !this.addPath(r, o))
              ) &&
              !("/" !== t && !o.addItem(i, e)) &&
              (se(e) && (this._index[t] = e), !0)
            );
          }),
          (Gi.prototype.addPathFast = function (t, e) {
            var n = t.lastIndexOf("/"),
              ...
              o = this._index[r];
            return (
              void 0 === o && ((o = new $i()), this.addPathFast(r, o)),
        ...
        var to = (function (t) {
          function e(n, r, i) {
            void 0 === r && (r = ""),
              ...
              t.call(this),
              n || (n = "index.json"),
              r.length > 0 && "/" !== r.charAt(r.length - 1) && (r += "/"),
              (this.prefixUrl = r);
            var o = null;
            if ("string" == typeof n) {
              if (((o = this._requestFileSync(n, "json")), !o))
                throw new Error(
          ...
          return (
            ...
            (e.Create = function (t, n) {
              void 0 === t.index && (t.index = "index.json"),
                "string" == typeof t.index
                  ? e.FromURL(t.index, n, t.baseUrl, !1)
                  : n(null, new e(t.index, t.baseUrl, !1));
            }),
            (e.isAvailable = function () {
              return (
                ...
                ? ((i = r.getData()),
                  i.size < 0
                    ? this._requestFileSizeAsync(t, function (t, e) {
                        return t
                          ? n(t)
                          : ((i.size = e), void n(null, i.clone()));
                      })
                    : n(null, i.clone()))
                : se(r)
                  ? ((i = r.getStats()), n(null, i))
                  : n(Fe.FileError(be.EINVAL, t));
            }),
            (e.prototype.statSync = function (t, e) {
              var n = this._index.getInode(t);
              if (null === n) throw Fe.ENOENT(t);
            ...
            (e.prototype.openSync = function (t, e, n) {
              ...
              switch (e.pathExistsAction()) {
                ...
                case Oe.NOP:
                  if (i.fileData)
                    return new Xe(this, t, e, i.clone(), i.fileData);
                  var o = this._requestFileSync(t, "buffer");
                  return (
                    (i.size = o.length),
                    (i.fileData = o),
                    new Xe(this, t, e, i.clone(), o)
                  );
                default:
          ...
          yo = (function (t) {
            function e(n, r, i) {
              void 0 === r && (r = ""),
                ...
                (this._eocd = null),
                d(i, e.Name, { zipData: "zip data as a Buffer", name: r }),
                n instanceof lo
                  ? ((this._index = n.index),
                    (this._directoryEntries = n.directoryEntries),
                    (this._eocd = n.eocd),
                    (this.data = n.data))
                  : ((this.data = n), this.populateIndex());
            }
            return (
              t && (e.__proto__ = t),
              (e.prototype = Object.create(t && t.prototype)),
              ...
              (e.computeIndex = function (t, n, r) {
                ...
                var i = new Gi(),
                  o = e.getEOCD(t);
                if (o.diskNumber() !== o.cdDiskNumber())
                  throw new Fe(
                    be.EINVAL,
                ...
                var s = o.cdOffset();
                if (4294967295 === s)
                  throw new Fe(be.EINVAL, "ZipFS does not support Zip64.");
                var a = s + o.cdSize();
                e.computeIndexResponsive(t, i, s, a, n, [], o);
              }),
              (e.getEOCD = function (t) {
                for (
                  var e = 22, n = Math.min(e + 65535, t.length - 1), r = e;
                  r < n;
                  r++
                )
                  if (101010256 === t.readUInt32LE(t.length - r))
                    return new po(t.slice(t.length - r));
                throw new Fe(
                  be.EINVAL,
              ...
              (e.addToIndex = function (t, e) {
                ...
                "/" === n.charAt(n.length - 1) &&
                  ...
                  t.isDirectory()
                    ? e.addPathFast("/" + n, new $i(t))
                    : e.addPathFast("/" + n, new Qi(t));
              }),
              ...
              (e.prototype.populateIndex = function () {
                ...
                if (n.diskNumber() !== n.cdDiskNumber())
                  throw new Fe(
                    be.EINVAL,
                    "ZipFS does not support spanned zip files.",
                  );
                ...
                for (var i = r + n.cdSize(); r < i; ) {
                  ...
                  (r += o.totalSize()),
                    e.addToIndex(o, t._index),
                    t._directoryEntries.push(o);
                }
              }),
              e
            );
        ...
        (yo.Name = "ZipFS"),
          ...
          (yo.CompressionMethod = oo),
          yo.RegisterDecompressionMethod(oo.DEFLATE, function (t, e, n) {
            return _(ro(t.slice(0, e), { chunkSize: n }));
          }),
          ...
          _o = (function (t) {
            function e(e) {
              if ((t.call(this, e), 1 !== this.type()))
                throw new Fe(be.EIO, "Invalid primary volume descriptor.");
            }
            return (
              t && (e.__proto__ = t),
              (e.prototype = Object.create(t && t.prototype)),
        ...
        (Eo.prototype.hasRockRidge = function () {
          ...
          (Eo.prototype._constructSUEntries = function (t) {
            ...
            e % 2 === 1 && e++,
              ...
              (this._suEntries = ye(this._data, e, this.length(), t));
          }),
            ...
            if (e.length > 0) {
              ...
              if (n instanceof Fo && n.checkBytesPass())
                for (var r = 1; r < e.length; r++) {
                  ...
                  if (
                    i instanceof To ||
                    (i instanceof Ro && i.extensionIdentifier() === go)
                  )
          ...
          Ho = (function (t) {
            function e(n, r, i) {
              ...
              void 0 === r && (r = ""),
                ...
                t.call(this),
                (this._data = n),
                d(i, e.Name, { data: "ISO data as a Buffer", name: r });
              ...
              c.forEach(function (t) {
                ...
                (this._root = this._pvd.rootDirectoryEntry(n)),
                (this._name = r);
            }
            return (
              t && (e.__proto__ = t),
              ...
              (e.prototype.openSync = function (t, e, n) {
                ...
                if (r.isSymlink(this._data))
                  return this.openSync(
                    ke.resolve(t, r.getSymlinkPath(this._data)),
                    e,
                    n,
                  );
              ...
              (e.prototype._getDirectoryRecord = function (t) {
                ...
                for (
                  ...
                  if (((r = r.getDirectory(e._data).getRecord(s)), !r))
                    return null;
                }
                return r;
              }),
              (e.prototype._getStats = function (t, e) {
                ...
                return (
                  (o &= 365),
                  new Te(
                    e.isDirectory(this._data) ? Le.DIRECTORY : Le.FILE,
                    i,
                    o,
                    a,
                    c,
        ...
        (Ho.Name = "IsoFS"),
          ...
          [Je, Kr, Gr, Qr, ri, li, mi, Ho, bi, Si, Vi, Xi, to, yo].forEach(
            function (t) {
              var e = t.Create;
    ...
    function (t, e, n) {
      (function (t) {
        ...
        function f(t) {
          for (
            var e = t.length < 0 ? 0 : 0 | l(t.length), n = i(e), r = 0;
            r < e;
            r += 1
          )
            n[r] = 255 & t[r];
        ...
        function p(e) {
          ...
          if (e) {
            if (Z(e) || "length" in e)
              return "number" != typeof e.length || Y(e.length) ? i(0) : f(e);
        ...
        function m(e, n, r, i, o) {
          ...
          if (("string" == typeof n && (n = t.from(n, i)), t.isBuffer(n)))
            return 0 === n.length ? -1 : _(e, n, r, i, o);
          if ("number" == typeof n)
            return (
              (n &= 255),
        ...
        (t.prototype.slice = function (e, n) {
          ...
          (t.prototype.readFloatLE = function (t, e) {
            return (
              (t >>>= 0), e || A(t, 4, this.length), K.read(this, t, !0, 23, 4)
            );
          }),
          (t.prototype.readFloatBE = function (t, e) {
            return (
              (t >>>= 0), e || A(t, 4, this.length), K.read(this, t, !1, 23, 4)
            );
          }),
          (t.prototype.readDoubleLE = function (t, e) {
            return (
              (t >>>= 0), e || A(t, 8, this.length), K.read(this, t, !0, 52, 8)
            );
          }),
          (t.prototype.readDoubleBE = function (t, e) {
            return (
              (t >>>= 0), e || A(t, 8, this.length), K.read(this, t, !1, 52, 8)
            );
          }),
    ...
    function (t, e, n) {
      (function (t) {
        ...
        (e.alloc = function (t, e, n) {
          ...
          var a = new i(t);
          if ("string" == typeof o)
            for (var c = new i(o, r), u = c.length, f = -1; ++f < t; )
              a[f] = c[f % u];
          else a.fill(o);
          return a;
        }),
          ...
          (e.from = function (e, n, r) {
            if (
              ...
              (!t.Uint8Array || Uint8Array.from !== i.from)
            )
              return i.from(e, n, r);
            if ("number" == typeof e)
              throw new TypeError('"value" argument must not be a number');
            ...
            if ("undefined" != typeof ArrayBuffer && e instanceof ArrayBuffer) {
              ...
              var s = r;
              if (
                ("undefined" == typeof s && (s = e.byteLength - o),
                o >= e.byteLength)
              )
                throw new RangeError("'offset' is out of bounds");
              if (s > e.byteLength - o)
    ...
    function (t, e, n) {
      (function (e) {
        ...
        function s(t) {
          return (
            (S = S || n(2)),
            T.call(s, this) || this instanceof S
        ...
        function f(t, e, n, r, o, s) {
          ...
          if ((c || (e.needDrain = !0), e.writing || e.corked)) {
            ...
            (e.lastBufferedRequest = new i(r, o, s)),
              f
        ...
        function E(t, e, n) {
          (e.ending = !0),
            w(t, e),
            n && (e.finished ? k(n) : t.once("finish", n)),
            (e.ended = !0),
            (t.writable = !1);
        }
        function b(t) {
        ...
        "function" == typeof Function.prototype[Symbol.hasInstance]
          ? ((T = Function.prototype[Symbol.hasInstance]),
            Object.defineProperty(s, Symbol.hasInstance, {
              value: function (t) {
                return (
                  !!T.call(this, t) || (t && t._writableState instanceof o)
                );
              },
            }))
          : (T = function (t) {
          ...
          (s.prototype.write = function (t, e, n) {
            ...
            return (
              ...
              i.ended
                ? a(this, n)
                : (s || c(this, i, t, n)) &&
                  (i.pendingcb++, (o = f(this, i, s, t, e, n))),
              o
            );
          }),
      ...
      (function (e) {
        ...
        function y(t, e) {
          for (
            ...
            (M("maybeReadMore read 0"), t.read(0), n !== e.length);
        ...
        function g(t) {
          return function () {
            ...
            M("pipeOnDrain", e.awaitDrain),
              ...
              0 === e.awaitDrain && A(t, "data") && ((e.flowing = !0), w(t));
          };
        }
        function v(t) {
        ...
        function b(t, e, n) {
          ...
          return (
            t < e.head.data.length
              ...
              : (r =
                  t === e.head.data.length ? e.shift() : n ? S(t, e) : k(t, e)),
            r
          );
        }
        function S(t, e) {
        ...
        (o.prototype.read = function (t) {
          ...
          if (
            ...
            return (
              ...
              0 === e.length && e.ended ? I(this) : p(this),
              null
            );
          ...
          M("need readable", r),
            (0 === e.length || e.length - t < e.highWaterMark) &&
              ((r = !0), M("length less than watermark", r)),
            e.ended || e.reading
          ...
          (o.prototype.pipe = function (t, n) {
            ...
            return (
              ...
              t.once("finish", f),
              t.emit("pipe", p),
              l.flowing || (M("pipe resume"), p.resume()),
              t
            );
          }),
          ...
          (o.prototype.on = function (t, e) {
            ...
            if ("data" === t)
              ...
              r.endEmitted ||
                ...
                (r.emittedReadable = !1),
                r.reading ? r.length && p(this, r) : L(v, this));
            }
            return n;
          }),
          ...
          (o.prototype.resume = function () {
            ...
            return (
              t.flowing || (M("resume"), (t.flowing = !0), m(this, t)), this
            );
          }),
    ...
    function (t, e) {
      ...
      function i(t) {
        ...
        return (
          2 === s
            ? ((o = (u[t.charCodeAt(e)] << 2) | (u[t.charCodeAt(e + 1)] >> 4)),
              (a[h++] = 255 & o))
            : 1 === s &&
              ((o =
                (u[t.charCodeAt(e)] << 10) |
    ...
    function (t, e, n) {
      ...
      function f(t) {
        if (_t) {
          ...
          for (b(k, t.lens, 0, 288, g, 0, t.work, { bits: 9 }), e = 0; e < 32; )
            t.lens[e++] = 5;
          b(I, t.lens, 0, 32, v, 0, t.work, { bits: 5 }), (_t = !1);
        }
        ...
        t: for (;;)
          switch (n.mode) {
            case U:
              ...
              if (((p >>>= 4), (l -= 4), (bt = (15 & p) + 8), 0 === n.wbits))
                n.wbits = bt;
              else if (bt > n.wbits) {
            ...
            case q:
              if (
                ...
                g &&
                  (n.head &&
                    ((bt = n.head.extra_len - n.length),
                    n.head.extra ||
                      (n.head.extra = new Array(n.head.extra_len)),
                    m.arraySet(n.head.extra, i, s, g, bt)),
                  512 & n.flags && (n.check = w(n.check, i, g, s)),
                  (c -= g),
                  (s += g),
                  (n.length -= g)),
                n.length)
                ...
                do
                  (bt = i[s + g++]),
                    n.head &&
                      bt &&
                      n.length < 65536 &&
                      (n.head.name += String.fromCharCode(bt));
                while (bt && g < c);
                if (
                  (512 & n.flags && (n.check = w(n.check, i, g, s)),
                  (c -= g),
                ...
                do
                  (bt = i[s + g++]),
                    n.head &&
                      bt &&
                      n.length < 65536 &&
                      (n.head.comment += String.fromCharCode(bt));
                while (bt && g < c);
                if (
                  (512 & n.flags && (n.check = w(n.check, i, g, s)),
                  (c -= g),
            ...
            case tt:
              ...
              if (
                ...
                (n.lenbits = 7),
                (kt = { bits: n.lenbits }),
                (St = b(S, n.lens, 0, 19, n.lencode, 0, n.work, kt)),
                (n.lenbits = kt.bits),
                St)
              ) {
            ...
            case et:
              ...
              if (
                ((n.lenbits = 9),
                (kt = { bits: n.lenbits }),
                (St = b(k, n.lens, 0, n.nlen, n.lencode, 0, n.work, kt)),
                (n.lenbits = kt.bits),
                St)
              ) {
              ...
              if (
                ...
                (kt = { bits: n.distbits }),
                (St = b(I, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, kt)),
                (n.distbits = kt.bits),
                St)
              ) {
            ...
            case rt:
              ...
              if (vt && 0 === (240 & vt)) {
                for (
                  _t = gt, wt = vt, Et = mt;
                  (Ot = n.lencode[Et + ((p & ((1 << (_t + wt)) - 1)) >> _t)]),
                    (gt = Ot >>> 24),
                    (vt = (Ot >>> 16) & 255),
                    (mt = 65535 & Ot),
                    !(_t + gt <= l);
            ...
            case ot:
              ...
              if (0 === (240 & vt)) {
                for (
                  _t = gt, wt = vt, Et = mt;
                  (Ot = n.distcode[Et + ((p & ((1 << (_t + wt)) - 1)) >> _t)]),
                    (gt = Ot >>> 24),
                    (vt = (Ot >>> 16) & 255),
                    (mt = 65535 & Ot),
                    !(_t + gt <= l);
              ...
              n.wrap &&
                ...
                (t.adler = n.check =
                  n.flags
                    ...
                    : _(n.check, o, y, t.next_out - y)),
              (t.data_type =
                n.bits +
                (n.last ? 64 : 0) +
                (n.mode === X ? 128 : 0) +
                (n.mode === nt || n.mode === G ? 256 : 0)),
              ((0 === d && 0 === y) || e === O) && St === R && (St = P),
              St)
        );
      }
      function l(t) {
      ...
      function y(t, e) {
        ...
        return t && t.state
          ? ((n = t.state),
            0 !== n.wrap && n.mode !== Y
              ? x
              : n.mode === Y && ((r = 1), (r = _(r, e, o, 0)), r !== n.check)
                ? A
                : (i = h(t, e, o, o))
                  ? ((n.mode = lt), D)
                  : ((n.havedict = 1), R))
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n, d, y, g, v, m) {
        ...
        if ((A > x && (A = x), 0 === x))
          return (y[g++] = 20971520), (y[g++] = 20971520), (m.bits = 1), 0;
        for (T = 1; T < x && 0 === z[T]; T++);
        ...
        for (;;) {
          (I = R - P),
            ...
            (w = 1 << D),
            (T = w);
          do (w -= _), (y[S + (M >> P) + w] = (I << 24) | (O << 16) | F | 0);
          while (0 !== w);
          for (_ = 1 << (R - 1); M & _; ) _ >>= 1;
          if (
            (0 !== _ ? ((M &= _ - 1), (M += _)) : (M = 0), L++, 0 === --z[R])
          ) {
            if (R === x) break;
            R = e[n + v[L]];
          }
          if (R > A && (M & b) !== E) {
            for (
              0 === P && (P = A), S += T, D = R - P, C = 1 << D;
              D + P < x && ((C -= z[D + P]), !(C <= 0));

            )
              D++, (C <<= 1);
            if (((U += 1 << D), (t === c && U > o) || (t === u && U > s)))
              return 1;
            (E = M & b), (y[E] = (A << 24) | (D << 16) | (S - g) | 0);
          }
        }
        return (
          0 !== M && (y[S + M] = ((R - P) << 24) | (64 << 16) | 0),
          (m.bits = A),
          0
        );
      };
